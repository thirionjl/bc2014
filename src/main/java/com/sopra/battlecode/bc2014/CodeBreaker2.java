...
public class CodeBreaker2 {
	...
	public static void main(String[] args) throws Exception {
		...
		printout("Some ciphered word are very frequent. It means that a same word is ciphered the same way multiple times, which indicates a block cipher");
		printout("The most frequent word in english is (by far) 'the' and 7 most frequent words are 3 chars length. They could all be different encryption of 'the'");
		...
		printout("Arrays have a lot of subsequences in common. Arrays are like connected together by the chain  0 19 2 14 3 4 1 (0 19)");
